...
```{r pairscatter, fig.width = 11, fig.height = 10, fig.path='plots/', dev = c('png','pdf')}
...
```{r heatmap-dist-vs-no286, fig.width=8.5, fig.height=7, fig.path='plots/', dev=c('png', 'pdf')}
...
```{r heatmap-orf-l2n, fig.width=8.5, fig.height=10, fig.path='plots/', dev=c('png', 'pdf')}
...
```{r heatmap-orf-vs, fig.width=9.5, fig.height=14, fig.path='plots/', dev=c('png', 'pdf')}
# subset counts of transformed (and normalized) counts
...
```{r heatmap-crispr-l2n, fig.width=8.5, fig.height=10, fig.path='plots/', dev=c('png', 'pdf')}
...
```{r heatmap-crispr-vs, fig.width=9.5, fig.height=14, fig.path='plots/', dev=c('png', 'pdf')}
# subset counts of transformed (and normalized) counts
mat <- assay(vst(dat.orig))[x,][c(rP, rN),]
rownames(mat) <- rowData(dat.orig)$symbol[x][c(rP, rN)]
colnames(mat) <- with(colData(dat.orig), paste0(mcc.id, " ", gsub("_", " ", type))) 
