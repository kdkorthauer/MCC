...
```{r heatmap-dist-vs-no286, fig.width=8.5, fig.height=7, fig.path='plots/', dev=c('pdf')}
...
```{r heatmap-expr-var-500-vs-vp, fig.width=8.5, fig.height=7, fig.path='plots/', dev=c('pdf')}
...
```{r heatmap-expr-var-500-vp, fig.width=8.5, fig.height=7, fig.path='plots/', dev=c('pdf')}
...
```{r track1, fig.height=8, fig.path='plots/', dev=c('pdf'), eval=FALSE}
...
```{r track2, fig.height=8, fig.path='plots/', dev=c('pdf'), eval=FALSE}
...
```{r MCCvirustrack, fig.height=8, fig.path='plots/', dev=c('pdf'), eval=FALSE}
mygenome[213] <- "t"
mygenome[1205] <- "c"
