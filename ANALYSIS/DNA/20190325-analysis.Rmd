...
mafdir <- "../../PREPROCESS/DNA/mutect2-gatk-results/"
```
...
maf_subset <- subsetMaf(maf, mafObj = TRUE,
                 tsb = maf@clinical.data$Tumor_Sample_Barcode[grep("5367|5368|5369",
...
names(fabcolors) = c("320", "367", "277", "314", "301")
