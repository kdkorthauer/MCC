...
```{r heatmap-dist-l2n, fig.width=8.5, fig.height=7, fig.path='plots/', dev=c('pdf')}
...
```{r heatmap-dist-vs, fig.width=8.5, fig.height=7, fig.path='plots/', dev=c('pdf')}
...
```{r heatmap-dist-var-l2n, fig.width=8.5, fig.height=7, fig.path='plots/', dev=c('pdf')}
# rank variable genes:
...
```{r heatmap-dist-var-vs, fig.width=8.5, fig.height=7, fig.path='plots/', dev=c('pdf')}
# rank variable genes:
...
```{r heatmap-expr-var-100-l2n, fig.width=8.5, fig.height=7, fig.path='plots/', dev=c('pdf')}
# Calculate distances using transformed (and normalized) counts
...
```{r heatmap-expr-var-100-vs, fig.width=8.5, fig.height=7, fig.path='plots/', dev=c('pdf')}
# Calculate distances using transformed (and normalized) counts
# only for top 100 genes
...
```{r heatmap-expr-var-100-vs-vp, fig.width=8.5, fig.height=7, fig.path='plots/', dev=c('pdf')}
...
```{r heatmap-expr-var-100-vp, fig.width=8.5, fig.height=7, fig.path='plots/', dev=c('pdf')}
...
```{r heatmap-goi-l2n, fig.width=8.5, fig.height=10, fig.path='plots/', dev=c('pdf')}
...
```{r heatmap-goi-vs, fig.width=8.5, fig.height=10, fig.path='plots/', dev=c('pdf')}
...
```{r heatmap-goi-l2n-lucas, fig.width=8.5, fig.height=10, fig.path='plots/', dev=c('pdf')}
# indices of genes of interest and extra HLA genes
x <- which(rowData(dat.orig)$symbol %in% goi$symbol)      
...
```{r heatmap-goi-vs-lucas, fig.width=8.5, fig.height=10, fig.path='plots/', dev=c('pdf')}
# subset counts of transformed (and normalized) counts
...
```{r heatmap-orf-l2n, fig.width=8.5, fig.height=10, fig.path='plots/', dev=c('pdf')}
...
```{r heatmap-orf-vs, fig.width=9.5, fig.height=14, fig.path='plots/', dev=c('pdf')}
# subset counts of transformed (and normalized) counts
...
```{r heatmap-crispr-l2n, fig.width=8.5, fig.height=10, fig.path='plots/', dev=c('pdf')}
...
```{r heatmap-crispr-vs, fig.width=9.5, fig.height=14, fig.path='plots/', dev=c('pdf')}
# subset counts of transformed (and normalized) counts
mat <- assay(vst(dat.orig))[x,][c(rP, rN),]
rownames(mat) <- rowData(dat.orig)$symbol[x][c(rP, rN)]
colnames(mat) <- with(colData(dat.orig), paste0(mcc.id, " ", gsub("_", " ", type))) 
...
```{r track1, fig.height=8, fig.path='plots/', dev=c('pdf'), eval=TRUE}
...
```{r track2, fig.height=8, fig.path='plots/', dev=c('pdf'), eval=TRUE}
...
```{r heatmap-DE-l2n-0.01, fig.width=8.5, fig.height=7, fig.path='plots/', dev=c('pdf')}
...
```{r heatmap-DE-vs-0.01, fig.width=8.5, fig.height=7, fig.path='plots/', dev=c('pdf')}
...
```{r}
res2 <- res
res2$log2FoldChange <- -1*res2$log2FoldChange
res2$stat <- -1*res2*stat
...
```{r gsea, fig.width=8, fig.height=9, fig.path='plots/', dev=c('pdf'), warning = FALSE, message = FALSE}
...
```{r gsea-collapsed, fig.width=8, fig.height=9, fig.path='plots/', warning = FALSE, message = FALSE, dev=c('pdf')}
...
```{r volcanogoi, fig.path='plots/', dev=c('pdf')}
...
```{r volcanoviral, fig.path='plots/', dev=c('pdf')}
...
```{r heatmap-DE-l2n-0.01-viral, fig.width=8.5, fig.height=7, fig.path='plots/', dev=c('pdf')}
...
```{r heatmap-DE-vs-0.01-viral, fig.width=8.5, fig.height=7, fig.path='plots/', dev=c('pdf')}
...
```{r gsea-viral, fig.width=8, fig.height=9, fig.path='plots/', dev=c('pdf'), warning = FALSE, message = FALSE}
topPathwaysUp <- goRes[ES > 0][head(order(pval), n=10), pathway]
topPathwaysDown <- goRes[ES < 0][head(order(pval), n=10), pathway]
topPathways <- c(topPathwaysUp, rev(topPathwaysDown))
plotGseaTable(goSets[topPathways], stats, goRes, 
...
```{r gsea-collapsed-viral, fig.width=8, fig.height=9, fig.path='plots/', warning = FALSE, message = FALSE, dev=c('pdf')}
collapsedPathways <- collapsePathways(goRes[order(pval)][padj < 0.05], 
                                      goSets, stats)
mainPathways <- goRes[pathway %in% collapsedPathways$mainPathways][
                         order(-NES), pathway][1:20]
...
```{r volcanogoiviral, fig.path='plots/', dev=c('pdf')}
p <- ggplot(data = df, aes(log2FoldChange, pvalue, color = DE.01)) +
    geom_point(alpha = 0.4) +
    ylab("-log10(p-value)") + 
    scale_colour_manual(values = c("black", "darkorange")) +
