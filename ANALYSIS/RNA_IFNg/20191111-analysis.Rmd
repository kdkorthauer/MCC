...
dat_control <- DESeqDataSetFromMatrix(countData = cbind(exp, exp_control),
                              colData = rbind(colDat, colDat_control),
                              rowData = rowDat,
                              design = ~ type)
```
...
# print table of vst values:
write.table(assay(vsd_control), quote=FALSE, file=file.path("results", "vst_expression_IFNg_withControlLines.txt"), sep="\t", col.names=NA)

# print housekeeping normed counts
write.table(assays(dat_control)$hk_norm, quote=FALSE, file=file.path("results", "housekeepingNormed_expression_IFNg_withControlLines.txt"), sep="\t", col.names=NA)
...
ha_column_control = HeatmapAnnotation(df = data.frame(
       ...
       col = list(Type = c(Naive="lightgrey", IFNg="black", 
